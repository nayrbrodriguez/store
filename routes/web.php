...
//Order Routes
	...
	Route::post('/payment/{id}', 'OrderController@payment')->name('porder');
...
//Accounts Routes
	...
	Route::post('/delete_accounts/{id}', 'AccountsController@destroy');

	Route::post('/password', 'AccountsController@showPassword');
});
