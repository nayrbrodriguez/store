...
<div class="row">
    ...
    <div class="panel panel-default">
        ...
        <div class="pull-right">
      <a href="{{url('admin/edit_banner',array($title->id))}}" class="btn btn-info">Edit</a>
       <a onclick="return confirm('Are you sure you want to delete {!!$title->title!!}?')" href="{{url('admin/delete_banner',array($title->id))}}" class="btn btn-danger ">Delete</a>
      </div>
