...
<div class="row">
    ...
    <div class="pull-right">
      ...
      <div class="panel-heading"><h3>Scholarships</h3>
   ...
   <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="{{ url('admin/update_scholarship') }}" method="post">
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <a href="{{url('admin/view_scholarship',$title->id)}}" class="btn btn-danger">Back</a>
            {!! csrf_field() !!}
